...
netprot_command.o: netprot_command.c netprot_command_list.h netprot_commands_misc.o netprot_commands_setget.o
	$(CC) $(CCFLAGS) -c netprot_command.c netprot_commands_misc.o netprot_commands_setget.o

netprot_commands_misc.o:
	$(CC) $(CCFLAGS) -c netprot_commands_misc.c

netprot_commands_setget.o:
